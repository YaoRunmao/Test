...
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.static import FONTS_DIR, GRAPHICS_DIR
...
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.visualization.pygame_utils import (
...
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.visualization.visualization_utils import (
