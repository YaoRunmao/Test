...
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.mdp.actions import Action
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.mdp.overcooked_mdp import (
    EVENT_TYPES,
    OvercookedGridworld,
)
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.mdp.overcooked_trajectory import (
    DEFAULT_TRAJ_KEYS,
    EPISODE_TRAJ_KEYS,
    TIMESTEP_TRAJ_KEYS,
)
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.planning.planners import (
    NO_COUNTERS_PARAMS,
    MediumLevelActionManager,
    MotionPlanner,
)
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.utils import append_dictionaries, mean_and_std_err
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.visualization.state_visualizer import StateVisualizer
...
class OvercookedEnv(object):
    ...
    def get_rollouts(
        ...
        from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.agents.benchmarking import AgentEvaluator
...
from onpolicy.envs.overcooked_ai.src.overcooked_ai_py.agents.agent import AgentPair
...
class Overcooked(gym.Env):
    ...
    def __init__(self, base_env, featurize_fn, seed, baselines_reproducible=False):
        """
        base_env: OvercookedEnv
        ...
        self.share_observation_space = self._setup_observation_space()
